        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              <a href="https://www.facebook.com/p/Cyberlab-Forensics-61567041316831/" className="text-gray-400 hover:text-[#00D9FF] transition-colors">
                <Facebook size={20} />
              </a>
              <a href="https://es.linkedin.com/company/cyberlabforensics" className="text-gray-400 hover:text-[#00D9FF] transition-colors">
                <Linkedin size={20} />
              </a>
              <a href="https://www.instagram.com/grupo_cyberlab_forensics/" className="text-gray-400 hover:text-[#00D9FF] transition-colors">
                <Instagram size={20} />
              </a>
            </div>
          </div>
