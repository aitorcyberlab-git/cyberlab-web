        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {regulations.map((regulation, index) => (
              <Card
                key={index}
                className="bg-gradient-to-br from-[#1A1A2E] to-[#0A0A0A] border-cyan-500/30 p-8 hover:glow-cyan transition-all duration-300 group"
              >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {whyChooseUs.map((item, index) => (
              <Card
                key={index}
                className="bg-gradient-to-br from-[#0A0A0A] to-[#1A1A2E] border-cyan-500/30 p-6 text-center hover:glow-cyan transition-all duration-300"
              >
